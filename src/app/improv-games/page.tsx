...
import { buildGamePools } from "@/lib/game-picker";
...
export default async function ImprovGamesPage() {
  ...
  return (
    // The hero is a sibling of `<main>`, not a child: it bleeds to the full
    // width of the viewport, and cancelling a centred padded column to do
    // that lands 7px wide of it (see HeroTakeover).
    <>
      <GamePicker pools={buildGamePools(games)} />
