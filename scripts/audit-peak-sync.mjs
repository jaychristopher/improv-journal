...
const ANCHORS = {
  ...
  L4: {
    timingsPath: "docs/youtube-week-3/L4-timings.json",
    currentPeaks: [5, 22, 8, 31, 45, 16, 20, 45, 35, 32, 54],
    peaks: [
      { num: 1, label: "Hook", anchor: ["rejection", "doesn't"] },
      { num: 2, label: "You're stuck", anchor: ["you", "sent"] },
      { num: 3, label: "Stakes (year that slips)", anchor: ["each", "freeze"] },
      { num: 4, label: "Gap reveal + open loop", anchor: ["that", "gap"] },
      { num: 5, label: "fMRI mechanism", anchor: ["but", "first"] },
      { num: 6, label: "Del Close + quote", anchor: ["del", "close"] },
      { num: 7, label: "Worked example (SNL → iO)", anchor: ["was", "fired"] },
      { num: 8, label: "Move 1 · Fail faster", anchor: ["what", "did", "del"] },
      { num: 9, label: "Move 2 · Move immediately", anchor: ["two", "move", "immediately"] },
      { num: 10, label: "Move 3 · Event vs meaning", anchor: ["three", "separate"] },
      { num: 11, label: "Long-game + CTA + callback", anchor: ["the", "improvisers"] },
    ],
  },
  L31: {
  ...
  "framing-effect": {
    timingsPath: "docs/youtube-week-4/framing-effect-timings.json",
    currentPeaks: [8, 25, 25, 40, 45, 18, 50, 35, 50, 25, 47],
    peaks: [
      { num: 1, label: "Hook", anchor: ["stop", "arguing"] },
      { num: 2, label: "Stakes (specific consequences)", anchor: ["was", "your", "idea"] },
      { num: 3, label: "Open loop + setup", anchor: ["three", "moves", "improv"] },
      { num: 4, label: "Tversky-Kahneman 1981 study", anchor: ["in", "1981"] },
      { num: 5, label: "Lakoff mechanism (Elephant)", anchor: ["george", "lakoff"] },
      { num: 6, label: "Midpoint reveal", anchor: ["failed", "persuasion"] },
      { num: 7, label: "Move 1 · Lead with the frame", anchor: ["common", "mistake"] },
      { num: 8, label: "Move 2 · Use their vocabulary", anchor: ["words", "carry"] },
      { num: 9, label: "Move 3 · Ask, don't assert", anchor: ["question", "lets"] },
      { num: 10, label: "Anti-move (craft vs spin)", anchor: ["framing", "slides"] },
      { num: 11, label: "Deeper point + CTA + callback", anchor: ["choice", "isn't"] },
    ],
  },
};
