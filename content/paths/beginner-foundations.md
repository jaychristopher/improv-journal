...
description: "A 7-day beginner program for learning the essential principles and first habits of improv."
learning_objectives:
...
estimated_time: "7 days, about 10-15 minutes a day plus short practice reps"
practice_cadence: "Day 1 and Day 2 teach the two core lessons. Days 3-7 are for repeating the drills, replaying the audio, and using the ideas in real conversations."
completion_outcome: "You'll finish with a simple daily improv loop and two foundational lessons you can use on stage and in real life."
program_type: course
...
Improv looks like magic from the outside: people making up scenes on the spot, building on each other seamlessly. But it's built on a small set of learnable principles. This program walks you through them in order, then asks you to repeat them until they start to feel automatic.

We start with **how scenes actually work** - the cycle of listening, receiving offers, and building on them. This is the engine that drives everything in improv. Get this right and the rest follows.
