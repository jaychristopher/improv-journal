...
**Debrief questions:** "Player A, when did you feel supported? When did you feel exposed?" "Player B, what was it like to have no agenda except making A look good?" "What was the first thing B saw, and what did they almost say instead?"

**Transfer to scene work:** In any scene, you can silently ask: "What is my partner building, and how do I make that look brilliant?" This question transforms you from a competitor into a collaborator.

**Lineage:** Keith Johnstone, "Presents" / "Blind Offers," *Impro* (1979), Spontaneity chapter — an unintentional gesture that the partner accepts and justifies. This atom's scene-starter format is closer to Patti Stiles / Hoopla's "Action and Justify" adaptation than Johnstone's original rapid-fire volley.
