...
links:
  ...
  - { id: elevating, relation: illustrates }
...
## Variation — Supporting Player (scene format)

Run a normal two-person scene, but before it starts, privately designate one player as the "support." The support player's only job is to make the other player's offers shine — no stealing focus, no redirecting, no pursuing their own ideas over their partner's. After two minutes, switch roles. Debrief: how did it feel to play from pure generosity? How did it feel to be supported? This variation trains the hardest form of the skill: choosing to serve your partner when your own impulses are competing for attention.

## Debrief questions

"Player A, when did you feel supported? When did you feel exposed?" "Player B, what was it like to have no agenda except making A look good?" "What was the first thing B saw, and what did they almost say instead?"

## Transfer to scene work

In any scene, you can silently ask: "What is my partner building, and how do I make that look brilliant?" This question transforms you from a competitor into a collaborator.

## Lineage

Keith Johnstone, "Presents" / "Blind Offers," *Impro* (1979), Spontaneity chapter — an unintentional gesture that the partner accepts and justifies. This atom's scene-starter format is closer to Patti Stiles / Hoopla's "Action and Justify" adaptation than Johnstone's original rapid-fire volley.