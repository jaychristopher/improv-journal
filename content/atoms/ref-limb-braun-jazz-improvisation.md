...
external_links:
  - { label: "Read the paper (PLOS ONE, open access)", url: "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0001679" }
sources: []
work:
  type: ScholarlyArticle
  authors: ["Charles J. Limb", "Allen R. Braun"]
  name: "Neural Substrates of Spontaneous Musical Performance: An fMRI Study of Jazz Improvisation"
  periodical: "PLoS ONE"
  published: "2008"
...
The most-cited piece of evidence that improvisation has a distinct neural signature, and the reason the phrase "get out of your head" turns out to be closer to literal than metaphorical.

Professional jazz pianists played inside an fMRI scanner on a specially built non-magnetic keyboard, alternating between reproducing an over-learned sequence and improvising freely over the same harmonic material. Because the two conditions demand near-identical motor activity, the contrast isolates the improvising itself rather than the playing.
