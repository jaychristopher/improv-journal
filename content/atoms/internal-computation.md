...
links:
  ...
  - { id: do-feel-say, relation: contrasts }
  - { id: trust, relation: contrasts }
  - { id: be-brave, relation: contrasts }
  - { id: judgment, relation: extends }
...
The more you try to prepare, the worse you perform. The preparation itself consumes the bandwidth you need to actually respond.

## Recovery — when you catch yourself computing

The fix is physical, not cognitive. You can't think your way out of thinking.
