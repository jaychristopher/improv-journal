...
links:
  ...
  - { id: audience-relationship, relation: enables }
...
### Calibrating the curve to the person
...
## Spolin's contribution

Her concept of "focus" (the shared Point of Concentration) is an externalized attention anchor. You cannot simultaneously monitor yourself and be genuinely absorbed in a task. Her exercises make absorption automatic. *Improvisation for the Theater*, Ch. 1-3.
