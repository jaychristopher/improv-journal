...
links:
  ...
  - { id: do-feel-say, relation: requires }
  - { id: emotional-truth, relation: enables }
  - { id: initiation, relation: enables }
...
**Specific sources:** Napier, *Improvise*, Ch. 3 — the three-step method ends with "hold onto what you did" as the commitment technique. Holding onto a perspective/emotion "will work as a support for them to have someone strong to play opposite." Johnstone, *Impro*, Ch. 2-3 — committed choices read as high status; the failure of commitment is "being the playwright" (stepping outside to manage). Johnstone: "the decision not to try and control the future allows students to be spontaneous." **Counter-position:** For Johnstone, over-commitment to your own idea is a form of blocking. The failure mode is bulldozing. Commitment must coexist with changeability — the atom's paradox section addresses this directly.
