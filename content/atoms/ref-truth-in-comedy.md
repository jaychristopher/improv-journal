...
title: "Truth in Comedy — Halpern, Close, Johnson (1994)"
type: reference
status: draft
...
The first book to write the Harold down, and the source of most of what Chicago longform believes about itself. It is the second most-cited work on this site after *Impro*.

For the lineage it speaks for, and the four schools it disagrees with, see [Close and Halpern](/traditions/close). For the form itself, see [the Harold](/practice/formats/harold). This page is about the book.

## What is actually in it

Less than the subtitle promises. It runs to about 160 pages, a good deal of which is argument and anecdote rather than instruction, and the tone is closer to a manifesto than a manual.

The through-line is a single claim — that comedy comes out of honest behaviour rather than out of jokes — pursued from several directions. Agreement, support and `group-mind` get the most space. `harold` itself arrives relatively late and is described more than it is taught: the shape is laid out, the beats named, and a reader who has never seen one performed will not come away able to run one.
