...
links:
  ...
  - { id: point-of-view, relation: enables }
...
Spolin, *Improvisation for the Theater*, Ch. IV-V — physicalization as the primary path to presence and authentic character. "If you can get it out of the head and into the body...Body, Mind, Intuition." Bogart & Landau, *The Viewpoints Book* (2005) — the nine physical Viewpoints as actor-training vocabulary; adapted from Mary Overlie's Six Viewpoints. Overlie, *Standing in Space: The Six Viewpoints Theory & Practice* (2016) — the original framework. Laban, *The Mastery of Movement* (4th ed., revised by Lisa Ullmann, 1980) — the Effort system. Napier, *Improvise*, Ch. 3 — "Do something. Check out what you did. Hold onto it." Johnstone, *Impro*, Ch. 5 ("Masks and Trance") — the body as medium for character that arrives from outside. Hines, ["Improv Shortcuts: Better Acting"](https://willhines.substack.com/p/improv-shortcuts-better-acting) — physicality, facial expression, and vocal inflection as the order of character creation. **Counter-position:** UCB's game-based tradition often de-emphasizes physicality in favor of verbal pattern recognition. A UCB scene can run entirely as "talking heads" when the comedic engine is the behavioral game, not the physical life. This isn't a principled rejection of physicality — it's a practical de-emphasis that reflects comedy's bias toward verbal wit. The risk: improvisers trained exclusively in game mechanics may never develop a physical vocabulary, limiting their character range to what the voice alone can produce.