...
**Specific sources:** Stanislavski, *An Actor Prepares* (1936), Ch. 7 ("Units and Objectives") and Ch. 15 ("The Super-Objective"). Meisner and Longwell, *Sanford Meisner on Acting* (1987) — the foundational question: "What do you want from the other person?" **Counter-position:** Johnstone was consciously reacting against Stanislavski — he found objectives limiting and developed narrative skills as an alternative. *Impro for Storytellers* includes an appendix called "Fast-Food Stanislavsky Lists," suggesting Johnstone saw objectives as useful shorthand, not a foundation. "Want" is a Stanislavski/Meisner import into improv, not native to Johnstone's framework.
