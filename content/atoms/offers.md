...
links:
  ...
  - { id: accepting-the-offer, relation: enables }
...
**Specific sources:** Johnstone, *Impro*, Ch. 3 ("Spontaneity") — the formal introduction of the offer/accept/block framework. *Impro for Storytellers*, Ch. 6 ("Making Things Happen," p. 101+) — expanded taxonomy. Hines, ["Accepting Offers"](https://willhines.substack.com/p/accepting-offers) — the fact/opinion distinction applied to offers. **Note:** "Everything is an offer" is Johnstone's formulation; no published counter exists, though UCB's emphasis on conscious game moves implicitly prioritizes intentional pattern-making over the "everything" frame.
