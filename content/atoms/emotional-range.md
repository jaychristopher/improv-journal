...
links:
  ...
  - { id: let-yourself-be-changed, relation: requires }
  - { id: vulnerability, relation: requires }
  - { id: presence, relation: requires }
  - { id: emotion-switch, relation: illustrates }
...
Meisner & Longwell, *Sanford Meisner on Acting* (1987) — the repetition exercise, emotional preparation, "Don't do anything unless something happens to make you do it," and "Acting is living truthfully under imaginary circumstances" (p. 63). The emotional preparation technique (daydream, not recalled trauma) is the specific method for bringing authentic emotion to the threshold of a scene. Spolin, *Improvisation for the Theater*, attitude-shifting exercises — the roots of emotion-switch work. Napier, *Improvise*, Ch. 3 — commitment to emotional choices; "give yourself one thing" can be an emotion as easily as a physicality. Hines, ["Improv Shortcuts: Better Acting"](https://willhines.substack.com/p/improv-shortcuts-better-acting) — "an improviser without access to their emotions has to be a very 'clever' improviser." Maggie Flanigan Studio, ["The Meisner Approach to Emotional Acting Techniques"](https://www.maggieflaniganstudio.com/post/the-meisner-approach-to-emotional-acting-techniques) — Meisner's distinction from Stanislavski's emotion memory. **Counter-position (Diderot's Paradox):** Denis Diderot, *Paradoxe sur le comedien* (written 1770-78, published 1830): the great actor feels nothing; they portray emotion through craft, observation, and intelligence, not through personal feeling. "Those actors who depend on feeling when performing usually give unpredictable or uneven performances." The Diderot position argues that emotional range is a technical skill (you learn to PERFORM any emotion convincingly) not a vulnerability skill (you learn to FEEL any emotion on stage). Most improv pedagogy aligns with the Meisner/Stanislavski tradition — feel it for real — but the Diderot position explains why some technically brilliant performers with no apparent emotional exposure can still produce devastating work. **Counter-position (game tradition):** UCB's game-based approach often deprioritizes emotional range in favor of behavioral consistency. A character defined by their game doesn't need to access grief if the game is about competitive one-upmanship. The emotional-range imperative comes primarily from the Meisner-influenced, relationship-driven traditions (TJ and Dave, Napier, iO Chicago). The tension: emotional range produces deeper human scenes; game consistency produces tighter comedic scenes. The best improvisers — TJ Jagodowski, Susan Messing, Joe Bill — resolve this tension by being capable of both.