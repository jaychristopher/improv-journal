---
id: ref-stiles-improvise-freely
title: "Improvise Freely — Patti Stiles (2021)"
type: reference
status: draft
tags: [references, books, safety, pedagogy, johnstone]
links:
  - { id: safety-in-the-room, relation: illustrates }
  - { id: giving-notes, relation: illustrates }
  - { id: be-supportive, relation: illustrates }
description: "The strongest published improv source on consent and safety, arguing that safety is what makes risk affordable rather than what you trade against it."
sources: []
work:
  type: Book
  authors: ["Patti Stiles"]
...
The strongest published improv-specific treatment of consent and safety, from a teacher in the Johnstone lineage with several decades of classroom practice behind the position.
...
- Consent as an ongoing negotiation in a class or ensemble, not a one-time agreement
- Notes aimed at what a student can do next, and the failure mode of notes that perform insight
- Rules as tools that expire, and the cost of holding one as an identity
