...
Johnstone, *Impro*, Ch. 2 ("Status") — the station/status mismatch as the foundational form of against-type character work. The king who plays low, the servant who plays high. Napier, *Improvise*, Ch. 7 — character from strong initial choices; the choice to play against expectation is one such strong choice, provided it's committed to fully. UCB Manual, Ch. 6 — against-type qualities can function as game when the contradiction is repeatable and heightenable. **Counter-position:** Playing against type can become its own cliche. If every tough guy is tender and every librarian is dangerous, the "subversion" becomes the new expectation, which is not subversive at all. The obvious choice — the tough guy who IS tough — can be equally powerful when played with specificity and emotional truth. See `obvious-choice`: sometimes the most surprising thing is the expected thing done with genuine commitment. The Annoyance Theater tradition (Napier, Kozlowski) would argue that the simplest, most committed version of any character is always stronger than a clever subversion of it. The antidote to cliche is not inversion — it is specificity.