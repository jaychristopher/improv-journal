...
**Specific sources:** UCB Manual, Ch. 2 ("Game") — the central concept of the book; finding, playing, and heightening game. **Counter-position (Johnstone):** Johnstone's *Impro* and *Impro for Storytellers* don't use "game" at all. His structural engine is **narrative** — reincorporation driving story forward, tilts reframing everything. Johnstone would argue "game" makes improvisers into joke-machines rather than storytellers. The fundamental tension: UCB sees pattern-and-escalation as the engine of comedy; Johnstone sees story-and-transformation as the engine of drama. Both produce compelling work.
