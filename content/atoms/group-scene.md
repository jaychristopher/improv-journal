...
**Specific sources:** UCB Manual, Ch. 7: "Using Support Moves to Play Game as a Group." Truth in Comedy, Ch. 8: "One Mind, Many Bodies" (group mind/ensemble) and Ch. 12: "Harold As a Team Sport." **Counter-position:** TJ & Dave work exclusively as a duo and are widely considered the gold standard of longform. Their work demonstrates that extraordinary improv needs only two people. Group scenes are a **format requirement** (Harold demands them) rather than an **artistic necessity**. The duo tradition (TJ & Dave, Middleditch & Schwartz) proves you can build entire shows without group scenes.
