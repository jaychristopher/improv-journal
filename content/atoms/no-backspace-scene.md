...
type: exercise
status: draft
tags: [exercises, intermediate, axioms, irreversibility, path-dependence]
links:
...
**Transfer:** In every scene, you are always living in the consequences of the last three seconds. This exercise builds the habit of looking forward from where you are, not backward to where you wish you were.

**Lineage:** Riffs on Keith Johnstone's "New Choice" (Theatresports / Loose Moose tradition, likely from exercises in *Impro*). New Choice replaces (coach calls "new choice," player substitutes); this exercise enforces keeping (coach calls "keep it," player justifies forward). The enforcement format is unpublished — an inversion of the Johnstone mechanic designed for this knowledge graph.
