...
**Transfer to scene work:** When your partner says something that should change you — and you feel the instinct to stay the same — that's the muscle this exercise trains. The goal is to make the shift feel like relief rather than loss.

**Lineage:** Standard exercise, widespread across traditions. Coach-calls-emotions format has roots in Spolin's attitude-shifting exercises (*Improvisation for the Theater*). "It's Tuesday": attributed to Johnstone, Loose Moose Theatre, 1970s (oral tradition — not confirmed in either published book).
