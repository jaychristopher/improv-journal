---
id: belief-as-architecture
title: Belief as Architecture
type: law
status: draft
...
links:
  ...
  - { id: rigid-core-malleable-edge, relation: enables }
...
## What this implies for any hard conversation

Three moves follow from the law:
...
Friston, "The free-energy principle: a unified brain theory?" (2010, *Nature Reviews Neuroscience* 11) — surprise minimization as the brain's organizing principle; high-confidence priors resist update. Andy Clark, *Surfing Uncertainty* (2016) — predictive processing as a unified framework; beliefs as generative models with metabolic cost to revise. Festinger, *A Theory of Cognitive Dissonance* (1957) — dissonance as aversive state resolved by cheapest available route. Kahan et al., "Motivated Numeracy and Enlightened Self-Government" (2017, *Behavioural Public Policy* 1) — identity-protective cognition; numeracy makes partisans *better* at dismissing inconvenient evidence. Haidt, *The Righteous Mind* (2012) — moral intuitions as the elephant; reasoning as the rider rationalizing structural commitments. Johnstone, *Impro*, Ch. 3 ("Spontaneity") — blocking as protection of the imagined-dangerous self.

## Counter-position

The architecture metaphor risks uniformity — not all beliefs are load-bearing, and treating every disagreement as a structural confrontation overstates the defense. Peripheral beliefs *do* update in response to evidence; people change minds about restaurants, vacation destinations, and tax policy with relative ease. The law applies most strongly to identity-anchored beliefs (moral, political, religious, professional-identity) and weakens toward the periphery. Also: people *do* undergo major belief change — religious conversion, political shifts, scientific paradigm change, recovery from ideology. The architecture can be remodeled, just not by direct argument; it tends to give way under sustained relational pressure, lived counter-evidence, or identity-rebuilding (new community, new role). A fairer statement of the law: *core beliefs are defended as architecture; peripheral beliefs are not; and the architecture itself remodels slowly, through pathways that look nothing like persuasion*.