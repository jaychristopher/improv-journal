...
**Lineage:** Keith Johnstone, "Presents," *Impro* (1979) — "a rather childish game, which is now often used with small children, but works really well" with adults. This version incorporates the blind offer mechanic (also Johnstone) where the giver does not decide what the object is — a hybrid of Presents + blind offer concept.
