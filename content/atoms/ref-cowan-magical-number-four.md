...
The estimate is contested at the edges — whether the limit is a fixed slot count or a flexible resource is still argued, and Cowan's own later work treats "about four" as a central tendency rather than a hard cap. Nothing on this site rests on the exact integer. It rests on the number being small.
