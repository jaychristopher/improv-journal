...
target_keywords:
  - { keyword: "how to be less awkward", volume: 700, difficulty: 2, traffic_potential: 900, parent: "how to not be socially awkward" }
  - { keyword: "social awkwardness", volume: 300, parent: "socially awkward" }
...
- **With new people** — your brain doesn't have a model for how they'll respond, so it over-monitors.
- **In groups** — more people watching means more perceived evaluation.
- **During silence** — without a script to follow, the monitoring takes over.
- **After a mistake** — a small stumble triggers a cascade of self-analysis.
