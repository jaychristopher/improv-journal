...
1. **Mirroring** → builds shared attention (the prerequisite for everything)
2. **Gift Giving** → practices surrendering control and receiving generously
3. **Yes, And Chain** → trains building on each other's contributions
4. **One-Word Scene** → applies everything in a structure where no one is in charge
