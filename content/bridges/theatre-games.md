...
target_keywords:
  - { keyword: "theatre games", volume: 1400, difficulty: 3 }
...
Spolin's central mechanic is that each game gives players one thing to attend to — and only one. Mirroring your partner's movement. Building the physical environment. Saying a single word at a time.

The constraint is doing the work. With one clear object of attention, there is no spare capacity for self-monitoring, and self-monitoring is what makes people stiff. You cannot simultaneously worry about looking foolish and track your partner's hand precisely. The game solves the problem by occupying the part of you that would otherwise be judging.
