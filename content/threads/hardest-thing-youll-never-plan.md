...
[^2]: Paul Merton inverts the common assumption: "It's not about what you say. It's about what you hear."

[^3]: This exercise draws on Viola Spolin's approach of using physical tasks (like counting floorboards while talking) to jam the internal deliberation circuit. If the brain is occupied receiving, it can't pre-plan.

[^4]: Tina Fey frames the alternative: "There are no mistakes, only beautiful happy accidents." Del Close and Charna Halpern extend it to the ensemble level: "If everyone justifies everyone else's actions, there are no mistakes."

[^5]: The deeper version: deliberately give "bad" gifts — a crumpled receipt, a handful of dirt. The receiver still finds genuine gratitude. This trains the hardest form of the skill: finding the offer in what looks like an error.
